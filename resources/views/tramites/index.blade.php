        ...
        <div class="container">              
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page" id="tramite-name">{{ strtoupper($type) }}</li>
                </ol>
            </nav>
            <div  style="min-height: 600px;" class="content d-flex flex-column flex-column-fluid pt-0">
                <div>
                    <section id="listaTramites" >
                        <listado-tramites :notary="{{session()->get("user")->notary->id}}" type="{{ $type }}"></listado-tramites>
                    </section>
                </div>
            </div>
        </div>
