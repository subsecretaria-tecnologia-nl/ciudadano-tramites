...
<html lang="en">
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed page-loading">
		...
		<div id="kt_header_mobile" class="header-mobile bg-primary header-mobile-fixed">
			<!--begin::Logo-->
			<a href="index.html">
				<img alt="Logo" src="{{ asset('images/logo.svg') }}" class="max-h-30px" />
			</a>
			<!--end::Logo-->
			<!--begin::Toolbar-->
			...
			<div class="d-flex flex-row flex-column-fluid page">
				...
				<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
													...
													<div class="topbar-item">
														<div class="btn btn-icon btn-hover-transparent-dark w-auto d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
															<div class="d-flex flex-column text-right pr-3">
																<span class="opacity-50 font-weight-bold font-size-sm d-none d-md-inline">Sean</span>
																<span class="font-weight-bolder font-size-sm d-none d-md-inline">UX Designer</span>
															</div>
															<span class="symbol symbol-35">
																<span class="symbol-label font-size-h5 font-weight-bold bg-dark-o-30">S</span>
															</span>
														</div>
													</div>
													<!--end::User-->
					...
					<div class="content d-flex flex-column flex-column-fluid" @if(isset($background_content)) style="background-color: {{$background_content}}" @endif id="kt_content">
						<!--begin::Entry-->
						<div class="d-flex flex-column-fluid   @if($empty_layout === true) justify-content-center align-items-center @endif">
							<?= view($viewPath, $args) ?>
						</div>
						<!--end::Entry-->
					</div>
