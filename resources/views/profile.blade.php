                        ...
                        <div class="dropdown-divider"></div>
                                        ...
                                        <form>
                                            <div class="card-body">
                                                ...
                                                <div class="form-group row">
                                                    <label for="example-search-input" class="col-3 col-form-label">Correo Electronico</label>
                                                    <div class="col-8">
                                 ...
                                 <form>
                                    <div class="card-body">
                                        <div class="form-group row">
                                            <label  class="col-3 col-form-label"></label>
                                            <div class="col-8">
                                                <label  class="col-8 col-form-label">Seguridad</label>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label  class="col-3 col-form-label">Verificacion Inicio de Sesion</label>
                                            <div class="col-8">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-3 col-form-label">Verificacion de restablecimiento de contraseña</label>
