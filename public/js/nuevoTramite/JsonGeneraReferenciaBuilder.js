  ...
  "tramite": [
    ...
    },
    {
      ...
      "detalle": [
    	...
    	//let generaReferencia = new JSONGeneraReferencia(this.token, this.url_retorno, this.importe_transaccion, this.id_transaccion, this.entidad, this.url_confirma_pago, this.tramite)
		//return generaReferencia.getJson();
    },
};
